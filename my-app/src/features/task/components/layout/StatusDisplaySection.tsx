...
export const StatusDisplaySection = () => {
    ...
    // ==========================================================
    return (
        <div className="border-1 flex flex-row items-center justify-start space-x-10 w-full px-5 py-2">
            <div className="flex flex-col items-start justify-center space-y-1">
                <div className="flex items-center justify-start">
                    <CircleCheckBig className="inline-block size-5" />
                    <p className="inline-block pl-2 w-18 min-w-18">完了済み</p>
                    <p className="inline-block">: {checkedTaskAmount}</p>
                </div>

                <div className="flex items-center justify-start">
                    <Circle className="inline-block size-5" />
